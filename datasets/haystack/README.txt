...
104. No real taxpayer information was used to produce it and none is
contained in it.

FILES
-----
companies.csv    901 rows. Upload this as the companies file.
invoices.csv     15368 rows. Upload this as the invoices file.
...
WHAT WAS PLANTED
----------------
     9 companies  high risk    - 2 circular-trade rings, 2 invoice mills
    25 companies  grey zone    - 5 ambiguous loops, 4 borderline sellers
    46 companies  honest loops - 18 genuine two-way traders
   821 companies  ordinary trade
...
Regenerating with seed 104 and the same settings produces these exact
files again.
